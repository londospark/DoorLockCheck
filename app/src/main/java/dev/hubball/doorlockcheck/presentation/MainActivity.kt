 ...
 * most up to date changes to the libraries and their uses.
 */
...
class MainActivity : ComponentActivity() {
    val viewModel: DoorLockViewModel by lazy {
        DoorLockViewModel(DoorLockDataStoreRepository(applicationContext))
    }
...
fun WearApp(viewModel: DoorLockViewModel) {
    val isLocked by viewModel.isLocked.collectAsState(initial = false)
    DoorLockCheckTheme {
        AppScaffold {
