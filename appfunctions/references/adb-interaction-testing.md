...
### Example 3: Execute a "send message" function
     ...
     --function 'com.example.messaging.appfunctions.MessagingAppFunctionService#sendMessage' \
...
### Example 4: Disable a specific function
     ...
     --function 'com.example.app.appfunctions.SomeAppFunctionService#someFunction' --state disable
